...
all_haram_final = all_haram + haram_ingredients1
all_kumandi_final = all_kumandi + suspected_ingredients

def check_halal_status(text):
    to_check = ["вода", "сок манго", "лимонная кислота","Беконные ножки"]
    #"аскорбиновая кислота", "сукралоза","пищевые красители", "E102", "E110"
    return check_ingredients(to_check, all_kumandi_final, all_haram_final, 100)
...
def check_ingredients(to_check, all_kumandi_final, all_haram_final, threshold=80):
    ...
    if is_haram:
        return "Харам", is_haram
    elif is_kumandi:
        return "Сомнительный", is_kumandi
    else:
        return "Халал", []
